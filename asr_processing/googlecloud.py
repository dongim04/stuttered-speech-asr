...
def transcribe_wav_file(data, file_name):
    ...
    if os.path.exists('C:/Users/dlee3/OneDrive - Olin College of Engineering/PInT/stuttered-speech-asr/temp.wav'):
        os.remove('C:/Users/dlee3/OneDrive - Olin College of Engineering/PInT/stuttered-speech-asr/temp.wav')
